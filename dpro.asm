...
int main(int argc, char *argv[]) {
  ...
  28:	74 6d                	je     97 <main+0x97>
      // parent
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  2a:	e8 64 03 00 00       	call   393 <getpid>
  2f:	53                   	push   %ebx
  for ( k = 0; k < n; k++ ) {
  30:	83 c6 01             	add    $0x1,%esi
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  33:	50                   	push   %eax
  34:	68 bc 07 00 00       	push   $0x7bc
  39:	6a 01                	push   $0x1
  3b:	e8 40 04 00 00       	call   480 <printf>
      wait();
  40:	e8 d6 02 00 00       	call   31b <wait>
  45:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  48:	39 f7                	cmp    %esi,%edi
  4a:	7e 2a                	jle    76 <main+0x76>
    pid = fork ();
  4c:	e8 ba 02 00 00       	call   30b <fork>
  51:	89 c3                	mov    %eax,%ebx
    if ( pid < 0 ) {
  53:	85 c0                	test   %eax,%eax
  55:	79 d1                	jns    28 <main+0x28>
      printf(1, "%d failed in fork!\n", getpid());
  57:	e8 37 03 00 00       	call   393 <getpid>
  ...
  exit();
  76:	e8 98 02 00 00       	call   313 <exit>
	n = atoi(argv[1]);
  7b:	83 ec 0c             	sub    $0xc,%esp
  7e:	ff 70 04             	push   0x4(%eax)
  81:	e8 1a 02 00 00       	call   2a0 <atoi>
  if (n < 0 ||n > 20)
  ...
  8e:	76 1f                	jbe    af <main+0xaf>
	n = 2;
  90:	bf 02 00 00 00       	mov    $0x2,%edi
  95:	eb 8a                	jmp    21 <main+0x21>
	printf(1,"Child %d created\n",getpid());
  97:	e8 f7 02 00 00       	call   393 <getpid>
  9c:	52                   	push   %edx
  9d:	50                   	push   %eax
  9e:	68 d9 07 00 00       	push   $0x7d9
  a3:	6a 01                	push   $0x1
  a5:	e8 d6 03 00 00       	call   480 <printf>
  aa:	83 c4 10             	add    $0x10,%esp
	for(z = 0; z < 4000000000; z+=1)
  ad:	eb fe                	jmp    ad <main+0xad>
  for ( k = 0; k < n; k++ ) {
  af:	85 c0                	test   %eax,%eax
  b1:	0f 85 6a ff ff ff    	jne    21 <main+0x21>
  b7:	eb bd                	jmp    76 <main+0x76>
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 4c 08 00 00 	movzbl 0x84c(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 f4 07 00 00 	jmp    *0x7f4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba eb 07 00 00       	mov    $0x7eb,%edx
        while(*s != 0){
 ...
 621:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 04 0b 00 00    	mov    %edx,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 ...
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 08 0b 00 00       	mov    $0xb08,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 786:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 792:	00 00 00 
    if(p->s.size >= nunits){
